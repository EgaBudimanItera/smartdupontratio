...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/assets/chosen-bootstrap/chosen/chosen.css" />
    ...
    <div id="header" class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="navbar-inner">
            <div class="container-fluid">
                <!-- BEGIN LOGO -->
                <a class="brand" href="#">
                    <img src="<?php echo base_url() ?>assets/img/logo.png" alt="Admin" />
                </a>
                <!-- END LOGO -->
                    ...
                    <ul class="nav pull-right top-menu" >                        
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?=base_url()?>user/logout"><i class="icon-key"></i> Log Out</a></li>
                            </ul>
                        </li>
